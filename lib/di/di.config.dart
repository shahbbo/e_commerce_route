...
import '../features/auth/data/remote_data_source/auth_remote_data_source.dart' as _i366;
import '../features/auth/data/remote_data_source/auth_remote_data_source_impl.dart' as _i125;
...
import '../features/auth/domain/use_case/signUp_use_case.dart' as _i194;
import '../features/auth/presentation/screens/sign_in/cubit/sign_in_cubit.dart' as _i203;
import '../features/auth/presentation/screens/sign_up/cubit/sign_up_cubit.dart' as _i134;
import '../features/cart/data/remote_data_source/cart_remote_data_source.dart' as _i1038;
import '../features/cart/data/remote_data_source/cart_remote_data_source_impl.dart' as _i143;
...
import '../features/cart/domain/use_cases/delete_item_in_cart_use_case.dart' as _i559;
import '../features/cart/domain/use_cases/get_cart_use_case.dart' as _i1030;
import '../features/cart/domain/use_cases/update_count_in_cart_use_case.dart' as _i274;
import '../features/cart/presentation/cubit/cart_screen_cubit.dart' as _i901;
import '../features/home_screen/data/remote_data_source/home_remote_data_source.dart' as _i1036;
import '../features/home_screen/data/remote_data_source/home_remote_data_source_impl.dart' as _i485;
...
import '../features/home_screen/domain/use_case/get_all_brands_use_case.dart' as _i749;
import '../features/home_screen/domain/use_case/get_all_categories_use_case.dart' as _i350;
import '../features/home_screen/presentation/cubit/home_tab_cubit.dart' as _i247;
import '../features/product_details/data/remote_data_source/product_details_remote_data_source.dart' as _i144;
import '../features/product_details/data/remote_data_source/product_details_remote_data_source_impl.dart' as _i761;
import '../features/product_details/data/repo/product_details_repository_impl.dart' as _i658;
import '../features/product_details/domain/repo/product_details_repository.dart' as _i636;
import '../features/product_details/domain/use_cases/product_details_use_case.dart' as _i487;
import '../features/product_details/presentation/cubit/product_details_cubit.dart' as _i666;
import '../features/products_screen/data/remote_data_source/products_remote_data_source.dart' as _i998;
import '../features/products_screen/data/remote_data_source/products_remote_data_source_impl.dart' as _i195;
import '../features/products_screen/data/repo/products_repository_impl.dart' as _i258;
import '../features/products_screen/domain/repo/products_repository.dart' as _i255;
import '../features/products_screen/domain/use_cases/add_to_cart_use_case.dart' as _i678;
import '../features/products_screen/domain/use_cases/get_all_products_use_case.dart' as _i107;
import '../features/products_screen/presentation/cubit/product_screen_cubit.dart' as _i411;
import '../features/wishlist_screen/data/remote_data_source/wishlist_remote_data_source.dart' as _i715;
import '../features/wishlist_screen/data/remote_data_source/wishlist_remote_data_source_impl.dart' as _i485;
import '../features/wishlist_screen/data/repo/wishlist_repository_impl.dart' as _i571;
import '../features/wishlist_screen/domain/repo/wishlist_repository.dart' as _i794;
import '../features/wishlist_screen/domain/use-cases/add_to_wishlist_use_case.dart' as _i634;
import '../features/wishlist_screen/domain/use-cases/get_wishlist_use_case.dart' as _i552;
import '../features/wishlist_screen/domain/use-cases/remove_from_wishlist_use_case.dart' as _i952;
import '../features/wishlist_screen/presentation/cubit/wish_list_cubit.dart' as _i805;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i366.AuthRemoteDataSource>(() =>
        _i125.AuthRemoteDataSourceImpl(apiManager: gh<_i259.DioHelper>()));
    ...
    gh.factory<_i194.SignUpUseCase>(() =>
        _i194.SignUpUseCase(authRepository: gh<_i981.AuthRepository>()));
    ...
    gh.factory<_i134.RegisterCubit>(() =>
        _i134.RegisterCubit(registerUseCase: gh<_i194.SignUpUseCase>()));
    gh.factory<_i805.WishListScreenCubit>(() => _i805.WishListScreenCubit(
          addToWishlistUseCase: gh<_i634.AddToWishlistUseCase>(),
          removeFromWishlistUseCase: gh<_i952.RemoveFromWishlistUseCase>(),
          getWishlistUseCase: gh<_i552.GetWishlistUseCase>(),
        ));
    ...
    gh.factory<_i411.ProductScreenCubit>(() => _i411.ProductScreenCubit(
          getAllProductUseCase: gh<_i107.GetAllProductUseCase>(),
          addToCartUseCase: gh<_i678.AddToCartUseCase>(),
          addToWishlistUseCase: gh<_i634.AddToWishlistUseCase>(),
          removeFromWishlistUseCase: gh<_i952.RemoveFromWishlistUseCase>(),
          getWishlistUseCase: gh<_i552.GetWishlistUseCase>(),
        ));
